...
public class HolidayTest {
    ...
    @Test
    void testReturnsBudgetInDesiredFormat() throws JsonProcessingException {
        ...
        Holiday holiday = new Holiday("Paris Getaway", group, holidayMakers, budgets);


        ObjectMapper objectMapper = new ObjectMapper().findAndRegisterModules();
        var expectedResponse = objectMapper.writeValueAsString(budgets);

        System.out.println("Budgets: " + holiday.getBudget());

        assertEquals(expectedResponse, holiday.getBudget());
    }

    @Test
    void testReturnsDatesInDesiredFormat() throws JsonProcessingException {
        ...
        System.out.println("Dates: " + expectedResponse);
...
//    @Test
//    void testAggregateHolidayBudget() {
//        User user1 = new User(
//                "1",
//                "User",
//                "User",
...
//        }};
//
//        assertEquals(expectedResponse, holiday.aggregateHolidaybudget());
//    }
